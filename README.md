...
| **supanova-design-skill** | 위 4개 Supanova 스킬 통합 패키지 (taste, output, redesign, soft) |
...
| Skill | 용도 |
|-------|------|
| **golang-patterns** | 관용적 Go 패턴, 베스트 프랙티스, 컨벤션 |
| **golang-testing** | Go 테스트 — 테이블 드리븐, 서브테스트, 벤치마크, 퍼징 |
